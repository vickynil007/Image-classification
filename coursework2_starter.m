...
%data_path = '../data/';
data_path = '/Users/sharonteresita/Documents/MATLAB/CV_Coursework2/data/';
...
% Variable parameters
colour = "grayscale"; % rgb, grayscale
    ...
    case 'colour histogram'
     ...
     case 'bag of sift'
      ...
      case 'spatial pyramids'
        ...
        if ~exist('vocab_spatial.mat', 'file')
            fprintf('No existing dictionary found. Computing one from training images\n')
            vocab_spatial = build_vocabulary(train_image_paths, vocab_size, colour); %Also allow for different sift parameters
            save('vocab_spatial.mat', 'vocab_spatial')
        end
          
        if ~exist('spatial_pyramid.mat', 'file')
            ...
            save('spatial_pyramid.mat', 'train_image_feats', 'test_image_feats')
        end  
end
